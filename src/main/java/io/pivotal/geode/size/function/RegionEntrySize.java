...
public class RegionEntrySize implements Serializable {
	...
	public String toString() {
		return new StringBuilder().append(getClass().getSimpleName()).append("[").append("regionEntrySize=")
				.append(this.regionEntrySize).append("; keySize=").append(this.keySize).append("; valueSize=")
				.append(this.valueSize).append("]").toString();
	}
}
